...
if( listings_wp_option( 'opening_html' ) ) {
	
	echo wp_kses_post( listings_wp_option( 'opening_html' ) );
	...
	switch( listings_wp_get_theme() ) {
		...
		case 'twentyseventeen' :
			...
			break;
		default :
			echo apply_filters( 'listings_wp_wrapper_start', '<div id="container" class="container"><div id="content" class="content" role="main">' );
			break;
	}
